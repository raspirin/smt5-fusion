...
impl Message {
    pub const ALL: [Self; 140] = [
        ...
        Self::NormalFusion,
        Self::NormalFusionAndUpgrade,
        Self::SpecialFusion,
        Self::InitialSkill,
        Self::ProvidedSkills,
        Self::OwnSkills,
        Self::InheritedSkills,
        Self::FilterMaterial,
    ...
    pub const fn id(self) -> &'static str {
        match self {
            ...
            Self::NormalFusionAndUpgrade => "normal-fusion-and-upgrade",
            Self::SpecialFusion => "special-fusion",
            Self::InitialSkill => "initial-skill",
            Self::ProvidedSkills => "provided-skills",
            Self::OwnSkills => "own-skills",
            Self::InheritedSkills => "inherited-skills",
